					...
					<div class="ibox-content">
						<form class="form-horizontal m-t" id="frm" method="post"
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select name="dormid" class="form-control" >
 				  						<#if dormitorys?exists>
   											
   											<#list dormitorys as dormitory>

  												<option value="${dormitory.id} " <#if student.dormitory.id == "${dormitory.id}">selected="selected"</#if>>
                                                    ${dormitory.building} ${dormitory.doorplate} 
                                                  </option>
  											 </#list>
  										</#if>
									</select>
